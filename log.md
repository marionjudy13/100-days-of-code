...
## Day 52: October 3, 2022

**Today's Progress:**
Worked on Plantonesv2 & My portfolio site a little

**Thoughts:**
Learned about Tailwind aspect ratios today! Also started adding styles for bigger breakpoints. Added on to my schema file as well. Also updated the link to Plantones in my portfolio site, and added a little png that introduces Mittens.

**Links:**

- [Plantones v2](https://plantonesv2.netlify.app/)
- [Portfolio Site](https://www.marionjudy.dev/passion-projects/plantones)

---

## Day 53 & Day 54: October 5 & 6, 2022

**Today's Progress:**
Logging for yesterday and today! Worked through the entire React docs tutorial & worked on my plantones site!

**Thoughts:**
Didn't log yesterday - too crazy of a day and it was one of the balls to be dropped. I tried to work on my Plantones project yesterday, but I ran into a few road blocks! I made notes on where I was stuck, and met up with my buddy Scott today to work through everything! I was trying to figure out how to import my background images from Sanity using Tailwind, and you can't (haha ugh). You can totally just add them dynamically using inline-styles though, so that was awesome! I also wanted each plant to have it's own page, so he helped me get that setup, too. I learned so much today! It's getting WAY easier to see what's happening in all of my projects, I love it. I also worked through the react docs tutorial today (the tic-tac-toe game). I want to really wrap my head around states, so I'm just going to keep building!
